...
### Alternative approach to identify shared TFs
...
xThreshold <- 300
# FDR correction for each lineage across all TFs
barplot(table(rowSums(aggStats > xThreshold)), xlab="Number of lineages in which a TF significantly peaks.")
sharedTF2 <- rownames(aggStats)[which(rowSums(aggStats > xThreshold) == 3)]
length(sharedTF2) # 72
mean(sharedTF %in% sharedTF2) # 75%
mean(sharedTF2 %in% sharedTF) # 68%
# Difference is that the multiple testing correction is more stringent if
# few TFs in that lineage have low signal while Fisher X threshold
# is agnostic to this.
```
...
heatmapScaledAcrossAllLineages(models=sce,
                              ...
                              cl=clDatta,
                              height=40,
                              outFile="../plots/peakAnalysis_Thresholded/neuronal/neurUniqTF_heatmapScaledAcrossAllLineages.pdf")
...
heatmapScaledAcrossAllLineages(models=sce,
                              ...
                              showRowNames = FALSE,
                              showLegend = FALSE,
                              outFile="../plots/peakAnalysis_Thresholded/neuronal/neurUniqTF_heatmapScaledAcrossAllLineages_paper.png")
heatmapScaledAcrossAllLineages(models=sce,
                              genes=neurUniqTFs,
                              nPoints=100,
                              sds=sds,
                              ...
                              showRowNames = FALSE,
                              showLegend = FALSE,
                              outFile="../plots/peakAnalysis_Thresholded/neuronal/neurUniqTF_heatmapScaledAcrossAllLineages_paper.pdf")
...
heatmapScaledAcrossAllLineages(models=sce,
                              ...
                              sds=sds,
                              cl=clDatta,
                              outFile="../plots/peakAnalysis_Thresholded/sus/susUniqTF_heatmapScaledAcrossAllLineages_threshold.pdf")
heatmapScaledAcrossAllLineages(models=sce,
                              genes=susUniqTFs,
                              nPoints=100,
                              sds=sds,
                              ...
                              showRowNames = FALSE,
                              showLegend = FALSE,
                              outFile="../plots/peakAnalysis_Thresholded/sus/susUniqTF_heatmapScaledAcrossAllLineages_paper.png")
heatmapScaledAcrossAllLineages(models=sce,
                              genes=susUniqTFs,
                              nPoints=100,
                              sds=sds,
                              ...
                              showRowNames = FALSE,
                              showLegend = FALSE,
                              outFile="../plots/peakAnalysis_Thresholded/sus/susUniqTF_heatmapScaledAcrossAllLineages_paper.pdf")
...
heatmapScaledAcrossAllLineages(models=sce,
                              ...
                              sds=sds,
                              cl=clDatta,
                              outFile="../plots/peakAnalysis_Thresholded/rhbc/rhbcUniqTF_heatmapScaledAcrossAllLineages.pdf")
...
heatmapScaledAcrossAllLineages(models=sce,
                              ...
                              showRowNames = FALSE,
                              showLegend = FALSE,
                              outFile="../plots/peakAnalysis_Thresholded/rhbc/rhbcUniqTF_heatmapScaledAcrossAllLineages_paper.png")
heatmapScaledAcrossAllLineages(models=sce,
                              genes=rhbcUniqTFs,
                              nPoints=100,
                              sds=sds,
                              ...
                              showRowNames = FALSE,
                              showLegend = FALSE,
                              outFile="../plots/peakAnalysis_Thresholded/rhbc/rhbcUniqTF_heatmapScaledAcrossAllLineages_paper.pdf")
```

...
## Muc5b
plot3d(reducedDim(sds), aspect = 'iso', col=colby(counts["Muc5b",], g=3), alpha=.6)
plot3d.SlingshotDataSet(sds, add=TRUE, col=c("black"), lwd=4)

##Sult1c1
plot3d(reducedDim(sds), aspect = 'iso', col=colby(counts["Sult1c1",], g=3), alpha=.6)
plot3d.SlingshotDataSet(sds, add=TRUE, col=c("black"), lwd=4)
...
## Pax3
plot3d(reducedDim(sds), aspect = 'iso', col=colby(counts["Pax3",], g=3), alpha=.6)
plot3d.SlingshotDataSet(sds, add=TRUE, col=c("black"), lwd=4)

## Pax7
plot3d(reducedDim(sds), aspect = 'iso', col=colby(counts["Pax7",], g=3), alpha=.6)
plot3d.SlingshotDataSet(sds, add=TRUE, col=c("black"), lwd=4)

## Pax9
plot3d(reducedDim(sds), aspect = 'iso', col=colby(counts["Pax9",], g=3), alpha=.6)
plot3d.SlingshotDataSet(sds, add=TRUE, col=c("black"), lwd=4)

## Dmrt2
plot3d(reducedDim(sds), aspect = 'iso', col=colby(counts["Dmrt2",], g=3), alpha=.6)
plot3d.SlingshotDataSet(sds, add=TRUE, col=c("black"), lwd=4)
